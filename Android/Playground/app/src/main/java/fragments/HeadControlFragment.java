...
public class HeadControlFragment extends BaseFragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    rootView.findViewById(R.id.button_head_top).setOnClickListener(createOnClickListener(-15, 0));
    rootView.findViewById(R.id.button_head_left).setOnClickListener(createOnClickListener(0, -90));
    rootView.findViewById(R.id.button_head_middle).setOnClickListener(createOnClickListener(0, 0));
    rootView.findViewById(R.id.button_head_right).setOnClickListener(createOnClickListener(0, 90));
    rootView.findViewById(R.id.button_head_bottom).setOnClickListener(createOnClickListener(5, 0));
