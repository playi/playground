...
public class HeadControlFragment extends BaseFragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    rootView.findViewById(R.id.button_head_top).setOnClickListener(createOnClickListener(Math.toRadians(120), 0));
    ...
    rootView.findViewById(R.id.button_head_bottom).setOnClickListener(createOnClickListener(Math.toRadians(-120), 0));
