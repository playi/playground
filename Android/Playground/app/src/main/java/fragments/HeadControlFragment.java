...
public class HeadControlFragment extends BaseFragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    rootView.findViewById(R.id.button_head_top).setOnClickListener(createOnClickListener(Math.toRadians(-15), 0));
    rootView.findViewById(R.id.button_head_left).setOnClickListener(createOnClickListener(0, Math.toRadians(90)));
    rootView.findViewById(R.id.button_head_middle).setOnClickListener(createOnClickListener(0, 0));
    rootView.findViewById(R.id.button_head_right).setOnClickListener(createOnClickListener(0, Math.toRadians(-90)));
    rootView.findViewById(R.id.button_head_bottom).setOnClickListener(createOnClickListener(Math.toRadians(5), 0));
